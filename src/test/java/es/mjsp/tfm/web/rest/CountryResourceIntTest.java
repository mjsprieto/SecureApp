...
import es.mjsp.tfm.repository.CountryRepository;
import es.mjsp.tfm.repository.search.CountrySearchRepository;
import es.mjsp.tfm.service.CountryService;
...
public class CountryResourceIntTest {
     ...
     *
     * @see es.mjsp.tfm.repository.search.CountrySearchRepositoryMockConfiguration
     */
    @Autowired
