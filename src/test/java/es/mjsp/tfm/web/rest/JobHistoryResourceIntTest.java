...
import es.mjsp.tfm.domain.JobHistory;
import es.mjsp.tfm.repository.JobHistoryRepository;
import es.mjsp.tfm.repository.search.JobHistorySearchRepository;
import es.mjsp.tfm.service.JobHistoryService;
...
import static es.mjsp.tfm.web.rest.TestUtil.createFormattingConversionService;
...
import es.mjsp.tfm.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIntTest {
     ...
     *
     * @see es.mjsp.tfm.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
