...
import es.mjsp.tfm.domain.Job;
import es.mjsp.tfm.repository.JobRepository;
import es.mjsp.tfm.repository.search.JobSearchRepository;
...
public class JobResourceIntTest {
     ...
     *
     * @see es.mjsp.tfm.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
